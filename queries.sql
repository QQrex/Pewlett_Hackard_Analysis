...
--DROP TABLE retirment_countby_dept;
...
-- Joing retirment_info and dept_emp tables short hand
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
COPY retirement_countby_dept TO 'C:\Users\Public\Postgres_Exports\retirment_count_by_dept.csv' DELIMITER ',' CSV HEADER;
...
-- departments added to current_emp table
